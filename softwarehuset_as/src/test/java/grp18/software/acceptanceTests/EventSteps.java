...
public class EventSteps {
    ...
    public void the_worker_s_eventlist_is_empty(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @When("the worker {string} registers working hours from {string} to {string} on date {string} with ID {string} related to activity {string}")
    public void the_worker_registers_working_hours_from_to_on_date_with_id_related_to_activity(String string, String string2, String string3, String string4, String string5, String string6) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @Then("an event labeled {string} with ID {string} related to activity {string} is added to the worker {string}'s eventlist")
    ...
    @Given("the worker {string} has an event from {string} to {string} on date {string} with ID {string}")
    public void the_worker_has_an_event_from_to_on_date_with_id(String string, String string2, String string3, String string4, String string5) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }

    @When("the worker {string} registers working hours from {string} to {string} on date {string} with ID {string}")
    public void the_worker_registers_working_hours_from_to_on_date_with_id(String string, String string2, String string3, String string4, String string5) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
