...
Scenario: A worker wants to change the timeframe of an event, and there is no overlap with new timeframe.
    ...
    And the worker "JHM" has an event from "12,00" to "14,00" on date "2022,2,6" related to activity with name "Activity 1" in project with ID 22001
    And the worker "JHM" has an event from "8,00" to "10,00" on date "2022,2,6" related to activity with name "Activity 1" in project with ID 22001
