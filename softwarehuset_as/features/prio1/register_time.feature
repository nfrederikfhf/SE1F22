...
Scenario: A worker adds an event to register hours
    ...
    When the worker "JHM" registers working hours from "08:00" to "17:00" on date "2022,2,5" with ID "000001" related to activity "Activity 1"
    Then an event labeled "work" with ID "000001" related to activity "Activity 1" is added to the worker "JHM"'s eventlist
